...
function prepareData(data: { plan: any; fact: any; }) {
...
function prepareInputForPrediction(inputData: { plan: number; }) {
  const prepared = {
...
function denormalizeOutput(normalizedValue: number) {
...
function getPrediction(inputData: any) {
